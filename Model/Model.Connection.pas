...
uses
  ...
  FireDAC.Phys.MySQLDef, FireDAC.Phys.MySQL, System.Classes, System.IniFiles,
  System.SysUtils;
...
begin
    try
        try
            ...
            FConn.Params.Add('Port=' + ini.ReadString('Banco de Dados', 'Port', ''));
            FConn.Params.Add('Server=' + ini.ReadString('Banco de Dados', 'Server', ''));
